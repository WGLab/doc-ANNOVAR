...
![new](img/new.png)2026Sep25: dbNSFP 5.4a in ANNOVAR is updated to include Interpro_domain. The hg19/hs1 data is available upon request due to disk storage limit.
