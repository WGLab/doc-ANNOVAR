...
---
![new](img/new.png)2024May25: dbSNFP version 4.7a and 4.7c (keyword: dbnsfp47a/dbnsfp47c) are available in ANNOVAR now on hg19 and hg38 coordinate. The avsnp151 is available in ANNOVAR now to assign dbSNP identifiers to variants on hg19 and hg38 coordinate.
