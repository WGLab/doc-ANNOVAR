...
![new](img/new.png)2019Nov27: A slight change was made to coding_change.pl to fix the 'argument G is not numeric in numeric gt (>)' bug, and you can download the updated file [here](http://openbioinformatics.org/annovar/download/coding_change.pl).
